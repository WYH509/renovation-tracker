      ...
      {stats && (
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="ios-card p-4">
            ...
            <p className="text-2xl font-bold text-ios-green">{formatCurrency(stats.totalPaid)}</p>
          </div>
          <div className="ios-card p-4">
            <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-2xl font-bold text-ios-orange">{formatCurrency(stats.totalUnpaid)}</p>
          </div>
          <div className="ios-card p-4">
            <div className="flex items-center gap-2 mb-2">
